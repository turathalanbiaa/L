...
class CreateUserRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "stage"       => ["required", Rule::in(Stage::getStages())],
            "certificate" => ["required", Rule::in(Certificate::getCertificates())],
            "birth_date"  => "required|date_format:Y-m-d|before_or_equal:".date('Y-m-d', strtotime('-15 years')),
            "address"     => "required"
        ];
    }
