...
@section("content")
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <table id="example" class="table table-hover table-responsive-xl btn-table">
            ...
            <div class="wrapper-editor">
                ...
                <table id="dtBasicExample" class="table table-striped w-100 table-bordered" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th class="th-sm">Name
